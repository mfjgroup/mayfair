...
html_title = """
    ...
    <style>
     ...
     <div class="container">
     <center><h1 class="title-test"> 🛩 Revenue and Inventory Report 📊 </h1></center>
     </div>
     </html>
"""
...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"> 
   <head>
    ...
    <ul>
      ...
      <li class="w3-large"><a href="Homet" target="_self"><i class="fa fa-home"></i> Home</a></li>
      <li class="w3-large"><a href="Inventory" target="_self">Inventory</a></li>
      <li class="w3-large"><a href="Revenue" target="_self">Revenue</a></li>
      <li class="w3-large"><a href="Transaction" target="_self">Transaction</a></li>
      <li class="w3-large"><a href="Payment" target="_self">Payment</a></li>
      <li class="w3-large"><a href="Report" target="_self">Report</a></li>
      <li class="w3-large"><a href="contributor" target="_self">Contributor</a></li>
      </div>
    </ul>
  </body>
</html>
