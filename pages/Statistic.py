...
html_title = """
    ...
    <style>
     ...
     <div class="container">
     <center><h1 class="title-test"> 🛩 Statistic Summary 📊 </h1></center>
     </div>
     </html>
"""
...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"> 
   <head>
    ...
    <ul>
      ...
      <li class="w3-large"><a href="DaysPrior" target="_self">Days Prior</a></li>
      <li class="w3-large"><a href="BookingTrend" target="_self">Booking Trend Prior</a></li>  
      </div>
    </ul>
  </body>
</html>
