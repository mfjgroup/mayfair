...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"> 
   <head>
    ...
    <ul>
      ...
      <li class="w3-large"><a href="Homet" target="_self"><i class="fa fa-homet" ></i> Revenue & Inventory Report</a></li>
      <li class="w3-large"><a href="PRL" target="_self"><i class="fa fa-homet></i> Flown & No-Show Data</a></li>
      <li class="w3-large"><a href="Statistic" target="_self"><i class="fa fa-homet"></i>Booking Statistics</a></li>
      </div>
    </ul>
  </body>
</html>
